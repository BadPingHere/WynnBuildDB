...
--
-- Table structure for table `buildsProdLR`
--

CREATE TABLE `buildsProdLR` (
  `id` int(20) NOT NULL,
...
--
-- Indexes for table `buildsProdLR`
--
ALTER TABLE `buildsProdLR`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `buildsProdLR`
--
ALTER TABLE `buildsProdLR`
