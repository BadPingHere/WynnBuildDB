...
--
-- Table structure for table `buildsProdXP`
--

CREATE TABLE `buildsProdXP` (
  `id` int(20) NOT NULL,
...
--
-- Indexes for table `buildsProdXP`
--
ALTER TABLE `buildsProdXP`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `buildsProdXP`
--
ALTER TABLE `buildsProdXP`
